...
public class UserApiController implements UserApi {
    ...
    public ResponseEntity<Void> createUser(@ApiParam(value = "Created profile object" ,required=true )  @Valid @RequestBody User body) {
    ...
    public ResponseEntity<User> getUserByName(@ApiParam(value = "The name that needs to be fetched. Use user1 for testing. ",required=true) @PathVariable("username") String username) {
        ...
        if (accept != null && accept.contains("application/xml")) {
            try {
                return new ResponseEntity<User>(objectMapper.readValue("<Profile>  <id>123456789</id>  <username>aeiou</username>  <first_name>aeiou</first_name>  <last_name>aeiou</last_name>  <email>aeiou</email>  <password>aeiou</password>  <phone>aeiou</phone>  <status>123</status></Profile>", User.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<User>(objectMapper.readValue("{  \"password\" : \"password\",  \"phone\" : \"phone\",  \"last_name\" : \"last_name\",  \"id\" : 0,  \"first_name\" : \"first_name\",  \"email\" : \"email\",  \"username\" : \"username\",  \"status\" : 6}", User.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
